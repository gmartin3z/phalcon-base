  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ url('perfil/actualizar-perfil-temporal') }}">
            {{ tr('limited_update_temp_profile') }}
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ url('perfil/verificar') }}">
            {{ tr('limited_verify') }}
          </a>
        </li>
      </ul>
      <ul class="nav navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="{{ url('perfil/salir') }}">
            {{ tr('limited_logout') }}
          </a>
        </li>
