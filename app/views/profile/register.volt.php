...
{% block title %}{{ tr('register_title') }}{% endblock %}
      ...
      <p>
        <div class="card text-white bg-primary mb-6">
          <div class="card-body">
            ...
            <h2 class="card-title">{{ tr('register_title') }}</h2>
            <p class="card-text">
              {{ form('perfil/registro', 'method': 'post', 'id': 'frm') }}
                <div class="form-group">
                  <label class="control-label" for="correo">{{ tr('register_alias') }}</label>
                  <div class="form-group">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" id="alias" name="alias" class="form-control frm-id"
                        placeholder="{{ tr('register_alias') }}" value="{{ old.alias is defined ? old.alias : '' }}">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label" for="correo">{{ tr('register_email') }}</label>
                  <div class="form-group">
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                      ...
                      <input type="text" id="correo" name="correo" class="form-control frm-id"
                        placeholder="{{ tr('register_email') }}" value="{{ old.correo is defined ? old.correo : '' }}">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label" for="contrasenia">{{ tr('register_password') }}</label>
                  <div class="form-group">
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                      ...
                      <input type="password" id="contrasenia" name="contrasenia" class="form-control frm-id"
                        placeholder="{{ tr('register_password') }}">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label" for="repetir_contrasenia">{{ tr('register_repeat_password') }}</label>
                  <div class="form-group">
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                      ...
                      <input type="password" id="repetir_contrasenia" name="repetir_contrasenia" class="form-control frm-id"
                        placeholder="{{ tr('register_repeat_password') }}">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <label for="captcha">{{ tr('register_captcha') }}</label>
                  <input type="text" id="captcha" name="captcha" class="form-control frm-id" placeholder="{{ tr('register_captcha') }}">
                </div>
