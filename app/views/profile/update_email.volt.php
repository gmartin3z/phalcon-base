...
{% block title %}{{ tr('update_email_title') }}{% endblock %}
      ...
      <p>
        <div class="card text-white bg-primary mb-6">
          <div class="card-body">
            ...
            <p class="card-text">
              {{ form('perfil/actualizar-correo', 'method': 'post', 'id': 'frm') }}
                <div class="form-group">
                  <label class="control-label" for="correo">{{ tr('upd_email_new_email') }}</label>
                  <div class="form-group">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" name="correo" class="form-control frm-id"
                        value="{{ old.correo is defined ? old.correo : admin.email }}">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label" for="contrasenia">{{ tr('upd_email_current_password') }}</label>
                  <div class="form-group">
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                ...
                <div class="form-group">
                  <label class="control-label" for="repetir_contrasenia">{{ tr('upd_email_confirm_password') }}</label>
                  <div class="form-group">
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
