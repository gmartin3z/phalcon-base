...
{% block title %}{{ tr('finish_recover_profile_title') }}{% endblock %}
    ...
    <div class="col-lg-6 col-centered">
      <p>
        <div class="card text-white bg-primary mb-6">
          <div class="card-body">
            <h2 class="card-title">{{ tr('finish_recover_profile_title') }}</h2>
            <p class="card-text">
              {{ partial('partials/alerts') }}
              {{ form('perfil/recuperar/finalizar/' ~ admin_id ~ '/' ~ token, 'method': 'post', 'id': 'frm') }}
                <div class="form-group">
                  <label class="control-label" for="contrasenia">{{ tr('f_rcv_prf_password_confirm_password') }}</label>
                  <div class="form-group">
                    <div class="input-group mb-3">
                      ...
                      <input type="password" id="contrasenia" name="contrasenia" class="form-control frm-id"
                        placeholder="{{ tr('f_rcv_prf_password_confirm_password') }}">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="captcha">{{ tr('f_rcv_prf_captcha') }}</label>
                  <input type="text" id="captcha" name="captcha" class="form-control frm-id" placeholder="{{ tr('f_rcv_prf_captcha') }}">
                </div>
