...
{% block title %}{{ tr('finish_update_password') }}{% endblock %}
            ...
            <p class="card-text">
              {{ form('perfil/actualizar-contrasenia/finalizar/' ~ admin_id ~ '/' ~ token, 'method': 'post', 'id': 'frm') }}
                <div class="form-group">
                  <label class="control-label" for="contrasenia">{{ tr('f_upd_password_new_password') }}</label>
                  <div class="form-group">
                ...
                <div class="form-group">
                  <label class="control-label" for="repetir_contrasenia">{{ tr('f_upd_password_confirm_new_password') }}</label>
                  <div class="form-group">
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
