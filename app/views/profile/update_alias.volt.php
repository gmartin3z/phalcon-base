...
{% block title %}{{ tr('update_alias_title') }}{% endblock %}
      ...
      <p>
        <div class="card text-white bg-primary mb-6">
          <div class="card-body">
            ...
            <p class="card-text">
              {{ form('perfil/actualizar-alias', 'method': 'post', 'id': 'frm') }}
                <div class="form-group">
                  <label class="control-label" for="correo">{{ tr('upd_alias_new_alias') }}</label>
                  <div class="form-group">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" name="alias" class="form-control frm-id"
                        value="{{ old.alias is defined ? old.alias : admin.alias }}">
                    </div>
                  </div>
                </div>
