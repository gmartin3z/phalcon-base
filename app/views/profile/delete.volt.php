...
{% block title %}{{ tr('delete_profile_title') }}{% endblock %}
      ...
      <p>
        <div class="card text-white bg-primary mb-6">
          <div class="card-body">
            ...
            <h2 class="card-title">{{ tr('delete_profile_title') }}</h2>
            <p>
            ...
            <p class="card-text">
              {{ form('perfil/borrar', 'method': 'post', 'id': 'frm') }}
                ...
                <div class="form-group">
                  <label class="control-label" for="repetir_contrasenia">{{ tr('del_prf_email_confirm_password') }}</label>
                  <div class="form-group">
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
