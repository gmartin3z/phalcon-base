...
{% block title %}{{ tr('recover_profile_title') }}{% endblock %}
      ...
      <p>
        <div class="card text-white bg-primary mb-6">
          <div class="card-body">
            ...
            <h2 class="card-title">{{ tr('recover_profile_title') }}</h2>
            <p class="card-text">
              {{ form('perfil/recuperar', 'method': 'post', 'id': 'frm') }}
                <div class="form-group">
                  <label class="control-label" for="correo">{{ tr('rcv_prf_current_email') }}</label>
                  <div class="form-group">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" id="correo" name="correo" class="form-control frm-id"
                        placeholder="{{ tr('rcv_prf_current_email') }}" value="{{ old.correo is defined ? old.correo : '' }}">
                    </div>
                  </div>
                </div>
                <div class="form-group">
